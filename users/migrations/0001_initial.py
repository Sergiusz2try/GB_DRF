# Generated by Django 3.2.8 on 2022-10-20 08:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to=users.models.users_avatars_path)),
                ('email', models.CharField(error_messages={'unique': 'A user with that email address already exists'}, max_length=250, unique=True, verbose_name='email address')),
